...
The next commit or so will include a better logging system, more comprehensively-defined routes, the transmission of images from the server to the client in binary format instead of Base64, and other features.
